...
pub const CHR_SET_ACTION: AobScan = AobScan {
    name: "ChrSetAction()",
    pattern: "48 89 5c 24 08 48 89 6c 24 10 48 89 74 24 18 57 48 83 ec 20 49 8b d8 48 8b fa 48 8b f1",
    scan_origin: 0x424952,
    offset: 0x25,
    scan_mode: AddressingMode::VfTableRelative { table_offset: 0x80 },
};
