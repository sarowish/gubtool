use crate::{
    common::{StrExt, blockless_list, stateful_list::StatefulList, tab_state::TabState, tabs_list}, darksouls2_screen::{GameState}, event::ResultExt
};
use crossterm::event::{KeyCode, KeyEvent};
use darksouls2::{
    game_state::{StateFlagOffset, StateFlags}, utility::{self}
};
use ratatui::{
    Frame,
