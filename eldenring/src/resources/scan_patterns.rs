...
pub const CHR_DBG_FLAGS: AobScan = AobScan {
    ...
    offset: 2,
    scan_mode: AddressingMode::Relative { bytes_to_next_instr: 5 },
};
...
pub const MAP_ITEM_MAN_IMPL: AobScan = AobScan {
    name: "MapItemManImpl",
    pattern: "44 8b 4f ? 48 8d 57 ? 44 8b 47 ? 48 8b 49 ? e8 ? ? ? ? 0f b6 d8 84 c0 74 49 48 8b 0d ? ? ? ?",
...
pub const MAP_DBG_FLAGS: AobScan = AobScan {
    ...
    offset: 11,
    scan_mode: AddressingMode::Relative { bytes_to_next_instr: 3 },
};
...
pub const GET_PLAYER_ITEM_QUANTITY_BY_ID: AobScan = AobScan {
    ...
    pattern: "40 57 48 83 ec 30 48 c7 44 24 20 fe ff ff ff 48 89 5c 24 58 48 8b f9 48 8d 44 24 48 48 89 44 24 50",
